...
messages = {
    ...
    "GINDASDPAR0002L": _("Removed DASD partition '%(ident)s'"),
    "GINFW0001L": _("Upgraded host firmware with '%(path)s'"),
    "GINFW0002L": _("Commited host firmware image from temp side to perm side"),
    "GINFW0003L": _("Rejected host firmware image on temp side"),
    "GINFS0001L": _("Mounted %(type)s filesystem at '%(mount_point)s'"),
    "GINFS0002L": _("Unmounted filesystem '%(ident)s'"),
    "GINHBK0001L": _("Discarded old archives"),
    "GINHBK0002L": _("Created archive with description '%(description)s'"),
    "GINHBK0003L": _("Removed archive '%(ident)s'"),
    "GINLV0001L": _("Created logical volume at volume group '%(vg_name)s'"),
    "GINLV0002L": _("Removed logical volume '%(ident)s'"),
    "GINNET0001L": _("Created configuration file for network interface"),
    "GINNET0002L": _("Removed configuration file for network interface '%(ident)s'"),
    "GINNET0003L": _("Updated configuration file for network interface '%(ident)s'"),
    "GINNET0004L": _("Redefined host network interface '%(ident)s'"),
    "GINNET0005L": _("Activated host network interface '%(ident)s'"),
    "GINNET0006L": _("Deactivated host network interface '%(ident)s'"),
    "GINNET0007L": _("Executed action '%(name)s' on network interface '%(ident)s'"),
    "GINNET0008L": _("Updated host network configuration"),
    "GINNET0009L": _("Confirmed changes on host network configuration"),
    "GINOVS0001L": _("Created OVS bridge '%(name)s'"),
    "GINOVS0002L": _("Removed OVS bridge '%(ident)s'"),
    "GINOVS0003L": _("Added interface '%(interface)s' to OVS bridge '%(ident)s'"),
    "GINOVS0004L": _("Removed interface '%(interface)s' from OVS bridge '%(ident)s'"),
    "GINOVS0005L": _("Added bonded port '%(bond)s' to OVS bridge '%(ident)s'"),
    "GINOVS0006L": _("Removed bonded port '%(bond)s' from OVS bridge '%(ident)s'"),
    "GINOVS0007L": _("Modified bonded port '%(bond)s' to replace interface '%(interface_del)s' with interface '%(interface_add)s' in OVS bridge '%(ident)s'"),
    "GINPART0001L": _("Created disk partition at '%(devname)s' with size %(partsize)s"),
    "GINPART0002L": _("Removed disk partition '%(ident)s'"),
    "GINPART0003L": _("Updated disk partition '%(ident)s' to type '%(type)s'"),
    "GINPART0004L": _("Formatted disk partition '%(ident)s' with filesystem '%(fstype)s'"),
    "GINPOWER0001L": _("Activated power saving profile '%(ident)s'"),
    "GINPV0001L": _("Created physical volume '%(pv_name)s'"),
    "GINPV0002L": _("Removed physical volume '%(ident)s'"),
    "GINSEP0001L": _("Started IBM Serviceable Event Provider (SEP)"),
    "GINSEP0002L": _("Stopped IBM Serviceable Event Provider (SEP)"),
    "GINSEP0003L": _("Subscribed '%(hostname)s' with IBM SEP"),
    "GINSEP0004L": _("Unsubscribed '%(ident)s' with IBM SEP"),
    "GINSEP0005L": _("Updated '%(ident)s' subscription with IBM SEP"),
    ...
    "GINSP0001L": _("Created swap device '%(file_loc)s'"),
    "GINSP0002L": _("Deleted swap device '%(ident)s'"),
    "GINSYSMOD0001L": _("Loaded kernel module '%(name)s'"),
